	...
	if (partie[a].tour === "passif") {
		...
		for (colonne = 0; colonne < 5; colonne++) {
			...
			for (ligne_1 = 0; ligne_1 < 10; ligne_1++) {
				...
				} else if (nb === partie[a].position && partie[a].compte === hote && p_b===false) {
					grille += "<img src = './html/pion_bleu.png' class='pion'> ";
				} else if (nb === partie[a].position && partie[a].compte !== hote && p_r===false) {
					grille += "<img src = './html/pion_rouge.png' class='pion'>";
				}

				if (nb === partie[b].position && partie[a].position === partie[b].position) {
					grille += "";
				} else if (nb === partie[b].position && partie[a].compte === hote && p_r===false) {
					grille += "<img src = './html/pion_rouge.png' class='pion'> ";
				} else if (nb === partie[b].position && partie[a].compte !== hote && p_b===false) {
					grille += "<img src = './html/pion_bleu.png' class='pion'>";
				}
